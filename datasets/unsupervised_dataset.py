...
class UnsupervisedDataset(object):
    ...
    def iterator(self, mode='sequential', batch_size=None, num_batches=None, rng_seed=0):
        ...
        if(mode == 'sequential'):
            ...
            self.iter = DatasetIteratorSequential(self.X, batch_size, num_batches, self.n_samples)   
            ...
            self.iter = DatasetIteratorRandomUniformNoRep(self.X, batch_size, num_batches, self.n_samples, rng_seed)
...
class DatasetIteratorSequential(BasicIterator):
    ...
    def __init__(self, X, batch_size=None, num_batches=None, num_samples=None):
        ...
        super(DatasetIteratorSequential, self).__init__(X, batch_size, num_batches, num_samples)
