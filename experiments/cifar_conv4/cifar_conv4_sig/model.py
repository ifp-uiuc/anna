...
class Model(object):
    ...
    conv2 = cc_layers.CudaConvnetConv2DLayer(conv1,
                                             ...
                                             init_bias_value=binit,
                                             nonlinearity=nonlinearity)
    conv3 = cc_layers.CudaConvnetConv2DLayer(conv2,
                                             n_filters=128,
                                             filter_size=3,
                                             weights_std=winit2,
                                             init_bias_value=binit,
                                             nonlinearity=nonlinearity)
    conv4 = cc_layers.CudaConvnetConv2DLayer(conv3,
                                             n_filters=128,
                                             filter_size=3,
                                             weights_std=winit2,
                                             init_bias_value=binit,
    ...
    deconv6 = cc_layers.CudaConvnetDeconv2DLayer(deconv5, conv3)
    deconv7 = cc_layers.CudaConvnetDeconv2DLayer(deconv6, conv2)
    output = cc_layers.CudaConvnetDeconv2DLayer(deconv7, conv1)
